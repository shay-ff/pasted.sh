...
export default function CodeEditor() {
  ...
  const language = languageContext ? languageContext.language : "plaintext"; // case handled if languageContext is undefined
  ...
  const handleEditorChange = (value: string | undefined) => {
    if (value !== undefined) {
      ...
      if (codeContext && codeContext.setCode) {
        codeContext.setCode(value); // Update the code in the context
      }
    }
  };
